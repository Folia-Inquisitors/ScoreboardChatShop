...
public class StringUtils {
	...
	public static String makeColors(String s){
        ...
        //&?? is a new "random hex color" variable
        s = s.replace("&??", randomHexColor());
        
        //&? is a new "random color" variable
...
//			Bukkit.broadcastMessage(hex);
	...
	public static String randomHexColor() {
		int hexInt = rand.nextInt(16777215+1); //16777215 is "FFFFFF" as hex
		return ChatColor.of("#" + String.format("%06x", hexInt)) + "";
	}
